...
def search_products(
    ...
    min_price: Annotated[float | None, Query(ge=0, description="Minimum selling price")] = None,
    max_price: Annotated[float | None, Query(ge=0, description="Maximum selling price")] = None,
